...
How to use express middleware and using server-side routing

-   [ ] Describe Middleware?

Middleware is diffrent functions that can be used in the order you give, and with express come inbetween the endpoint being called and the code in the endpoint

-   [ ] Describe a Resource?

A resource is the data stored in the api
...
By using serverside routering with express
